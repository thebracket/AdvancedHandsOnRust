  ...
  T: States+Copy+FromWorld+FreelyMutableState,
{
  fn build(&self, app: &mut App) {
    ...
    let start = MenuResource {
      ...
      game_start_state: self.game_start_state,//<callout id="flappy_menus.menu_resource" />
    ...
    app.add_systems(OnExit(self.menu_state), 
      cleanup::<game_menus::MenuElement>);//<callout id="flappy_menus.cleanup" />
...
//START: load_assets
#[derive(Resource)]
pub(crate) struct MenuAssets {//<callout id="flappy_menus.pub_crate" />
