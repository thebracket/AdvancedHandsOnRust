...
use my_library::{RandomNumberGenerator, RandomPlugin};//<callout id="random.bevy.use" />
...
fn setup(
  ...
  commands.insert_resource(GameAssets { image: texture, layout: texture_atlas_layout }); //<callout id="first_library_create.pig.store_assets" />
