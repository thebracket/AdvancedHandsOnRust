...
// START: xorshift
#[cfg(all(not(feature = "pcg"), not(feature = "xorshift")))]// <callout id="rng.pcg_or_xor" />
type RngCore = rand::prelude::StdRng;

#[cfg(feature = "pcg")]// <callout id="rng.pcg_only" />
type RngCore = rand_pcg::Pcg64Mcg;

#[cfg(feature = "xorshift")]
type RngCore = rand_xorshift::XorShiftRng;// <callout id="rng.xor_only" />
//END: xorshift
